...
public class TopologicalSortDFS 
{
	...
	public static void toposort(boolean vis[] , Stack<Integer> st , int node)
	{
		vis[node] = true;
	...
	public static ArrayList<Integer> findTopoSort(int n)
	{
	...
	public static void main(String h[])
	{
		...
		boolean f = hasCycle();
		if(f) {
			System.out.println("NO TOPOLOGICAL SORT AVAILABLE ; GRAPH IS CYCLIC");
			return;
		}
